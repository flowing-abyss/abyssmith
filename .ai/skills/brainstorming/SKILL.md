...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md` (gitignored: it stays local, never commit it)
...
- Do not commit it: `docs/` is gitignored and stays local (never force-add it)
