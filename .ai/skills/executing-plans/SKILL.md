...
- Each plan owns a workspace: at skill start, run
  `node ../subagent-driven-development/scripts/sdd-workspace.mjs PLAN_FILE` — it
...
- Run this skill's `node scripts/task-start.mjs PLAN_FILE N`. It prints the brief
...
Run this skill's `node scripts/task-done.mjs PLAN_FILE N BASE -- <test command>`
...
Run `node ../subagent-driven-development/scripts/review-package.mjs PLAN_FILE MERGE_BASE HEAD`
...
[Resolve workspace: node ../subagent-driven-development/scripts/sdd-workspace.mjs docs/superpowers/plans/feature-plan.md — no ledger inside, fresh start]
...
[task-done plan 1 a1b2c3d -- pnpm test -- hooks → ledger: Task 1: complete (commits a1b2c3d..d4e5f6a, tests: pnpm test -- hooks → 1/1 pass)]
...
[task-done plan 2 d4e5f6a -- pnpm test -- recovery → ledger: Task 2: complete (commits d4e5f6a..b7c8d9e, tests: pnpm test -- recovery → 8/8 pass)]
